...
export const metadata: Metadata = {
  title: "haidozo — 相手のことを想って、プレゼントを選ぼう",
  description: "誰かが悩んで選んだ贈り物の理由から、あなたにぴったりのプレゼントが見つかる。",
};
      ...
      <div className="lp">
        ...
        <section className="section">
          <div className="wrap">
            ...
            <p className="lead" style={{ maxWidth: 560 }}>
              haidozo に記録されているのは、アイテム名だけじゃない。選んだ理由と、贈った相手のこと。
            </p>
              ...
              {STORIES.map((s, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ borderLeft: "3px solid #E8502A", paddingLeft: 16, marginBottom: 22, flex: 1 }}>
                    <p style={{ fontSize: 14, color: "#2B3467", lineHeight: 1.9 }}>
                      「{s.reason}」
                    </p>
                  </div>
                  <div>
