    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .lp { font-family: var(--font-sans, system-ui, sans-serif); background: #FFF7ED; color: #2A2521; }
        .wrap { max-width: 1040px; margin: 0 auto; padding: 0 32px; }
        @media (min-width: 768px) { .wrap { padding: 0 64px; } }
        .section { padding: 96px 0; }
        .section-alt { padding: 96px 0; background: #fff; border-top: 1px solid rgba(42,37,33,0.07); border-bottom: 1px solid rgba(42,37,33,0.07); }
        .eyebrow { font-size: 11px; font-weight: 800; color: #FF5A1F; letter-spacing: 0; margin-bottom: 20px; }
        .h2 { font-size: clamp(26px, 3.5vw, 38px); font-weight: 800; line-height: 1.25; letter-spacing: 0; color: #2A2521; margin-bottom: 20px; }
        .lead { font-size: clamp(14px, 1.5vw, 16px); color: #6E645C; line-height: 1.9; }
      ...
      <div className="lp">
        {/* Version bar */}
        <div style={{ background: "#2A2521", padding: "8px 0", textAlign: "center" }}>
          <div style={{ fontSize: 12, color: "rgba(255,255,255,0.5)" }}>
            ...
            {"　"}
            <strong style={{ color: "#FF5A1F" }}>v5（v2 design）</strong>
          </div>
        </div>

        {/* ── Nav ── */}
        <nav style={{
          borderBottom: "1px solid rgba(42,37,33,0.08)",
          ...
          <div className="wrap" style={{ height: 60, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <Link href="/" style={{
              background: "#FF5A1F", color: "#fff", borderRadius: 100,
        ...
        <section style={{ padding: "100px 0 96px", textAlign: "center" }}>
          <div className="wrap">
            ...
            <h1 style={{
              ...
              color: "#2A2521", maxWidth: 820, margin: "0 auto 28px",
            }}>
              なにあげよ？<br />から、はじめる。
            </h1>
            <p style={{
              fontSize: "clamp(15px, 1.8vw, 18px)",
              color: "#6E645C", lineHeight: 1.85,
            ...
            <Link href="/" style={{
              ...
              boxShadow: "0 8px 28px rgba(255,90,31,0.34)",
        ...
        <section className="section-alt">
          <div className="wrap">
            ...
            <p style={{ fontSize: "clamp(18px, 2.5vw, 24px)", fontWeight: 800, color: "#FF5A1F", lineHeight: 1.5, marginBottom: 24, maxWidth: 640 }}>
              そのプレゼント、どうして選んだの？
            </p>
            ...
            <div className="flow-cards">
              {STEPS.map((step) => (
                <div key={step.n} style={{
                  background: step.accent ? "rgba(255,90,31,0.05)" : "#fff",
                  border: `1.5px solid ${step.accent ? "rgba(255,90,31,0.24)" : "rgba(42,37,33,0.08)"}`,
                  borderRadius: 20, padding: "24px 22px",
                  display: "flex", flexDirection: "column", gap: 12,
                }}>
                  <div style={{
                    width: 40, height: 40, borderRadius: 12,
                    background: step.accent ? "rgba(255,90,31,0.12)" : "rgba(42,37,33,0.06)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                  }}>
                    <span style={{ fontSize: 12, fontWeight: 800, color: step.accent ? "#FF5A1F" : "#2A2521" }}>{step.n}</span>
                  </div>
                  <div style={{ fontSize: 16, fontWeight: 700, color: "#2A2521" }}>{step.title}</div>
                  <div style={{ fontSize: 13, color: "#6E645C", lineHeight: 1.8 }}>{step.body}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="wrap">
            ...
            <div className="mock-row">
              ...
              <div style={{
                ...
                background: "#FFF7ED", border: "1.5px solid rgba(42,37,33,0.1)",
                borderRadius: 24, padding: 24, boxShadow: "0 8px 32px rgba(42,37,33,0.08)",
              }}>
                <p style={{ fontSize: 11, fontWeight: 700, color: "#A89E94", letterSpacing: "0.06em", marginBottom: 14 }}>
                  あとで考える
                </p>
                <div style={{
                  background: "#fff", border: "1px solid rgba(42,37,33,0.08)",
                  ...
                  <div style={{ display: "flex", gap: 12, alignItems: "center", marginBottom: 10 }}>
                    <div style={{
                      ...
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontSize: 16, fontWeight: 800, color: "#FF5A1F",
                    }}>母</div>
                    <div>
                      <p style={{ fontSize: 14, fontWeight: 800, color: "#2A2521", marginBottom: 4 }}>お母さん</p>
                      <div style={{ display: "flex", gap: 5 }}>
                        {["家族", "誕生日"].map((t) => (
                          <span key={t} style={{ fontSize: 10, fontWeight: 600, padding: "2px 8px", borderRadius: 100, background: "rgba(42,37,33,0.06)", color: "#6E645C" }}>{t}</span>
                        ))}
                      </div>
                    </div>
                  </div>
                  <p style={{ fontSize: 12, color: "#6E645C", lineHeight: 1.7, marginBottom: 12 }}>
                    「最近vlogを始めて楽しそう。ネタになるものもいいかも」
                  </p>
                  <div style={{
                    background: "#FF5A1F", borderRadius: 100, padding: "10px",
                ...
                <div style={{
                  border: "1.5px dashed rgba(255,90,31,0.42)", borderRadius: 16,
                  padding: "13px", textAlign: "center",
                  fontSize: 13, fontWeight: 700, color: "#FF5A1F",
              ...
              <div style={{
                width: "100%", maxWidth: 400,
                background: "#fff", border: "2px solid rgba(255,90,31,0.2)",
                borderRadius: 24, padding: 24, boxShadow: "0 8px 32px rgba(255,90,31,0.08)",
                ...
                <div style={{
                  background: "linear-gradient(135deg, rgba(255,90,31,0.08) 0%, #fff8f5 100%)",
                  border: "1.5px solid rgba(255,90,31,0.24)",
                  borderRadius: 16, padding: "16px 18px", marginBottom: 16,
                }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: "#FF5A1F", letterSpacing: "0.08em", marginBottom: 8 }}>
                    あの人に、これだ
                  </p>
                  <p style={{ fontSize: 16, fontWeight: 800, color: "#2A2521", lineHeight: 1.7 }}>
                    出かける口実ごと、<br />プレゼントしたい
                  </p>
                </div>
                <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 16 }}>
                  {["出かける口実をあげたかった", "ふたりで楽しんでほしい"].map((v) => (
                    <span key={v} style={{ fontSize: 11, padding: "4px 11px", borderRadius: 100, background: "rgba(255,90,31,0.08)", color: "#FF5A1F", fontWeight: 600 }}>{v}</span>
                  ))}
                </div>
                <p style={{ fontSize: 12, color: "#6E645C", lineHeight: 1.8, marginTop: "auto" }}>
            ...
            <div style={{ textAlign: "center", marginTop: 48 }}>
              <Link href="/" style={{
                display: "inline-flex", alignItems: "center", gap: 8,
                border: "2px solid #FF5A1F", color: "#FF5A1F",
            ...
            <div className="grid-3">
              {EPISODES.map((ep, i) => (
                <div key={i} style={{
                  ...
                  <div style={{
                    background: "rgba(255,90,31,0.06)", borderRadius: 12,
                    padding: "12px 14px", marginBottom: 18,
                  }}>
                    <p style={{ fontSize: 11, fontWeight: 700, color: "#FF5A1F", letterSpacing: "0.06em", marginBottom: 6 }}>
                      こんなふうに喜んでほしかった
                    </p>
                    <p style={{ fontSize: 13, color: "#2A2521", lineHeight: 1.8, fontWeight: 500 }}>
                      {ep.wish}
                    </p>
                  </div>
                  <div style={{ borderLeft: "2px solid rgba(42,37,33,0.12)", paddingLeft: 14, marginBottom: 20, flex: 1 }}>
                    <p style={{ fontSize: 13, color: "#6B7280", lineHeight: 1.85 }}>
                      {ep.reason}
                    </p>
                  </div>
                  <div>
                    <p style={{ fontSize: 12, fontWeight: 700, color: "#2A2521", marginBottom: 8 }}>{ep.item}</p>
                    <span style={{
                      fontSize: 11, background: "rgba(255,90,31,0.08)", color: "#FF5A1F",
        ...
        {/* ── Final CTA ── */}
        <section style={{ background: "#2A2521", padding: "100px 0 112px", textAlign: "center" }}>
          <div className="wrap">
            <div style={{ fontSize: 26, fontWeight: 800, color: "#fff", letterSpacing: 0, marginBottom: 18 }}>
              haidozo
            </div>
            ...
            <Link href="/" style={{
              ...
              boxShadow: "0 8px 32px rgba(255,90,31,0.42)",
            }}>
              なにあげよ？を始める →
            </Link>
